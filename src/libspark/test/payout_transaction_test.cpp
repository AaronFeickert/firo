...
BOOST_FIXTURE_TEST_SUITE(spark_payout_transaction_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(generate_verify)
{
    ...
    // Generate address and coin
    PayoutCoinData output;
    output.address = Address(incoming_view_key, 12345);
    output.v = 678;
